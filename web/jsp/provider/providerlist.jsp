...
<div class="right">
        ...
        <div class="search">
        	<form method="get" action="${pageContext.request.contextPath }/provide/provideLimit">
				<input name="method" value="query" type="hidden">
				<span>供应商编码：</span>
				<input name="queryProCode" type="text" value="${param.queryProCode }">
                <input type="hidden" name="pageIndex" value="1"/>
				<span>供应商名称：</span>
				<input name="queryProName" type="text" value="${param.queryProName }">
				
				<input value="查 询" type="submit" id="searchbutton">
				<a href="${pageContext.request.contextPath }/jsp/provider/provideradd.jsp">添加供应商</a>
			</form>
        </div>
        <!--供应商操作表格-->
        <table class="providerTable" cellpadding="0" cellspacing="0">
            ...
            <c:forEach var="provider" items="${providerList.list }" varStatus="status">
				<tr>
					<td>
    ...
    <c:import url="../rollpage.jsp">
        <c:param name="totalCount" value="${providerList.totalCount}"/>
        <c:param name="currentPageNo" value="${providerList.pageIndex}"/>
