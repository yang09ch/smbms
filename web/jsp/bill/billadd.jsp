...
<div class="right">
     ...
     <div class="providerAdd">
         <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/bill/doadd">
             ...
             <div class="">
				 ...
				 <!-- 放置提示信息 -->
				 <font color="red"></font>
                 <input type="hidden" name="createdBy" value="${sessionScope.user.id}"/>
             </div>
             <div>
