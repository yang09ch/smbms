...
<div class="right">
        ...
        <div class="providerAdd">
          <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/bill/doUpdate">
					...
					<select name="providerId" id="providerId">
                        <c:if test="${providerList != null }">
                            ...
                            <c:forEach var="provider" items="${providerList}">
                                <option value="${provider.id}" ${provider.id==bill.providerId?"selected":""}>
